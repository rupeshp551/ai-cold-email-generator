...
const Dashboard = () => {
    ...
    const { fetchHistory, selected, setSelected } = useHistory();
    ...
    /* Full view of selected history item */
    if (selected) {
        return (
            <div className="max-w-5xl mx-auto bg-white p-6 rounded-xl border relative">
                ...
                <ResultCard title="Subject Line" content={selected.subject} type="subject" />
                <ResultCard title="Cold Email" content={selected.emailBody} type="email" />
                <ResultCard title="LinkedIn DM" content={selected.linkedInDM} type="linkedin" />
                <ResultCard title="Follow-up Email" content={selected.followUpEmail} type="followup" />
            </div>
        );
    }
            ...
            <div className="w-full lg:w-2/3 flex flex-col overflow-y-auto">
                {result ? (
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-gray-400 bg-white border border-gray-200 rounded-xl">
                        ...
                        <p className="text-sm">
                            Submit a prompt to generate AI outputs.
                        </p>
                    </div>
                )}
            </div>
