        ...
        <div className="bg-white min-h-screen font-sans selection:bg-primary-100 selection:text-primary-900">
                ...
                <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
                            Join hundreds of sales professionals using MailCraft to accelerate their pipeline today.
                        </p>
            ...
            <footer className="bg-white border-t border-gray-100 py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
                    ...
                    <p className="text-gray-500 text-sm">© {new Date().getFullYear()} MailCraft AI. All rights reserved.</p>
                </div>
            </footer>
        </div>
    );
